...
public class GameManager : MonoBehaviour
{
    ...
    // Fungsi[Range(min,max)] adalah untuk menjaga value agar tetap
    // berada  di antara min  dan max nya.
    ...
    private void CollectPerSecond()
    {
        ...
        //Fungsi ToString("F1") adalah untuk membulatkan angka menjadi desimal 
        // yang memiliki 1 angka di belakang  koma
